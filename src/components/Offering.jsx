...
const Offering = () => {
  return (
    <div className="flex flex-col items-center gap-6 mx-6">
      <div className="grid md:grid-cols-2 lg:w-[55%] lg:grid-cols-4 gap-4">
        <div className="border-2 border-[#f0f0f0] bg-[#f6f4f5] rounded-lg first-letter shadow-md hover:bg-white  cursor-pointer">
          <div className="my-4 ml-4 flex flex-col gap-4 ">
            <div className="flex gap-3 items-center">
              <svg
                className=" w-[15%] h-[15%] p-1 rounded-lg bg-[#dda5fd] border-black"
                viewBox="0 0 25 25"
              >
                <g>
              ...
              <div className="px-2 rounded-xl bg-[#f1e1f8] text-[#9d35db] font-bold">
                Now with Q&A
              </div>
            </div>
            <div className="text-base font-normal mr-4">
        ...
        <div className="border-2 border-[#f0f0f0] bg-[#f6f4f5] rounded-lg first-letter shadow-md hover:bg-white  cursor-pointer">
          <div className="my-4 ml-4 flex flex-col gap-4 ">
            <div className="flex gap-3 items-center">
              <svg
                className="w-[15%] h-[15%] p-1 rounded-lg bg-[#fda09a] border-black"
                viewBox="0 0 49 49"
              >
                <path
              ...
              <div className="text-2xl font-bold">Wikis</div>
            </div>
            <div className="text-base font-normal mr-4">
        ...
        <div className="border-2 border-[#f0f0f0] bg-[#f6f4f5] rounded-lg first-letter shadow-md hover:bg-white  cursor-pointer">
          <div className="my-4 ml-4 flex flex-col gap-4 ">
            <div className="flex gap-3 items-center">
              <svg
                className="w-[15%] h-[15%] p-1 rounded-lg bg-[#a1dbff] border-black"
                viewBox="0 0 49 49"
              >
                <path
        ...
        <div className="border-2 border-[#f0f0f0] bg-[#f6f4f5] rounded-lg first-letter shadow-md hover:bg-white  cursor-pointer">
          <div className="my-4 ml-4 flex flex-col gap-4 ">
            <div className="flex gap-3 items-center">
              <svg
                className="w-[15%] h-[15%] p-1 rounded-lg bg-[#f8d99b] border-black"
                viewBox="0 0 49 49"
              >
                <path
                  ...
                  fill="currentColor"
                ></path>
                <path d="M17.75 27.232h13.5M17.75 34.402h13.5"></path>
              </svg>
